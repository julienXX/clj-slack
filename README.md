...
This is on [Clojars](https://clojars.org/org.julienxx/clj-slack) of course. Just add ```[org.julienxx/clj-slack "0.4.3"]``` to your ```:dependencies``` in your project.clj file.
